...
/**
 * Unit tests for {@see uk.ac.ucl.twitter.compliance.persist.TweetToVerifyWeeklyEntity}
 ...
 *
 */
class TweetToVerifyWeeklyEntityTest {

  @Test
  public void hasEntityAnnotation() {
    Class<TweetToVerifyWeeklyEntity> clEntity = TweetToVerifyWeeklyEntity.class;
